...
public class VARegistrar extends JPanel {
	...
	public VARegistrar() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
				    ...
				    String query = "SELECT idmesa FROM atemesa WHERE idMESA = ? AND estado = ? AND capacidad >= ?";
				    ...
				    if (!resultSet.next()) {
				      ...
				      JOptionPane.showMessageDialog(null, "Mesa no encontrada o no está libre");
			            ...
			            PreparedStatement ps = conexion.conexion().prepareStatement("INSERT INTO atereserva"
		             ...
		             if(RESERADO.isSelected()==true) {
		            	...
		            	PreparedStatement ps2 = conexion.conexion().prepareStatement("UPDATE atEmesa SET estado = 'RESERVADA'  WHERE idmesa = ?");
		            	ps2.setInt(1, mesa);
		            	ps2.executeUpdate();
		            	...
		            	PreparedStatement ps3 = conexion.conexion().prepareStatement("UPDATE atEmesa SET estado = 'OCUPADA'  WHERE idmesa = ?");
		            	ps3.setInt(1, mesa);
		            	ps3.executeUpdate();
		...
		JLabel lblNewLabel_6 = new JLabel("GESTION DE RESERVA ATENEO INMACULADA");
	...
	public void cargar() throws SQLException {
		...
		String sqlmc = "SELECT idMesa, capacidad, estado FROM atemesa where estado = 'LIBRE' ";
        //Statement st;
